...
class MCPAuthManager:
    ...
    def create_document_access_token(self, petition_id: str, document_identifier: str,
                                   application_number: str) -> str:
        """
        Create a token specifically for document access.

        Args:
            petition_id: Petition ID for the document
